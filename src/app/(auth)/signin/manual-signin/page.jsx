    ...
    <div className="signin w-vw h-[90vh] flex flex-col items-center justify-center gap-2.5">
      ...
      <form className="flex flex-col items-center justify-center gap-4 w-full max-w-xs">
        <div className="relative w-full">
          <Input placeholder="Email" className="w-full py-5 pl-10" />
          <Mail
        ...
        <div className="w-full flex justify-end -mt-2 mb-1">
          ...
          >
            <Link href="/signin/forgot-password" className="text-muted-foreground text-xs text-text">Forgot Password?</Link>
          </Button>
        </div>
        <div className="w-full flex justify-center">
          <Button
            variant="default"
            className="w-full py-6 cursor-pointer bg-primary 
          text-blue-50 text-md hover:bg-primary/90 transition-all duration-300 ease-in-out
        ...
        <div className="w-full flex items-center justify-center gap-1">
          <h2 className="text-muted-foreground text-sm">Don't have an account?</h2>
          <span className="text-muted-foreground ">
            <Button variant="link" className="p-0 h-auto mb-1">
              <Link href="/signup" className="text-primary text-md font-semibold">
                Sign up
              </Link>
            </Button>
          </span>
